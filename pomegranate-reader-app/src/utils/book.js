...
//     vue.$store.dispatch('setMenuVisible', false).then(() => {
//     })
//
//     vue.$store.dispatch('setSettingVisible', 0).then(() => {
//     })
//
//     vue.$store.dispatch('setFontFamilyVisible', false).then(() => {
//     })
//
//     vue.$store.dispatch('setSpeakingIconBottom', realPx(58)).then(() => {
//     })
// }
